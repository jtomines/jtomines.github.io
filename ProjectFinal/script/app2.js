...
function display(Year) {
    ...
    d3.csv("../data/suicide_rate.csv", function(suicideAll) {
        console.log(Year);
        suicideAll.forEach(function(d) {
            if (d.year == Year) {
                suicideRates.push(d);
            }
        });
        ...
        svg.selectAll(".dot")
            ...
            .on("mouseover", function(d) {
                ...
                d3.select("#tooltip")
                    ...
                    .style("top", d3.event.pageY + "px")						
                    .select("#value")
                    .html('<b>State:</b> ' + d.state + '<br/><b>Suicides:</b> ' + d.DEATHS + 
                            '<br/><b>Suicide Rate:</b> ' + d.RATE + ' per 100,000');
